...
use Laminus\Diactoros\Response as DiactorosResponse;
use Laminus\Diactoros\ServerRequest;
use Laminus\Diactoros\ServerRequestFactory as DiactorosRequestFactory;
use Laminus\Diactoros\Stream as DiactorosStream;
use Laminus\Diactoros\UploadedFile as DiactorosUploadedFile;
...
class DiactorosFactory implements HttpMessageFactoryInterface
{
    ...
    public function createResponse(Response $symfonyResponse)
    {
        ...
        if (!isset($headers['Set-Cookie']) && !isset($headers['set-cookie'])) {
            $cookies = $symfonyResponse->headers->getCookies('flat');
            if (!empty($cookies)) {
